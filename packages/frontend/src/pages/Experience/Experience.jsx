...
const ExperienceCard = ({
  ...
  icon,
    ...
    const Icon = iconMap[icon] || Code2; // Fallback to Code2 icon
    return (
...
const ExperienceSection = () => {
  ...
  if (loading) return <div className="bg-black text-white h-screen flex items-center justify-center">Loading Experience...</div>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
            {experiences.map((exp, index) => (
              <ExperienceCard 
                ...
                icon={index === 0 ? "Network" : index === 1 ? "Layers" : "Code2"} // Example of assigning icons
              />
            ))}
          </div>
        </div>
